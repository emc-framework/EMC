...
public class IMinecraft {
	...
	public static boolean isFocused() {
		return ((IMixinMinecraft) Minecraft.getMinecraft()).getIsWindowFocused();
	}

	public static double getScaleFactor() {
		return Minecraft.getMinecraft().mainWindow.getGuiScaleFactor();
	}
	...
	public static void triggerGuiRenderer() {
		Minecraft.getMinecraft().mainWindow.setupOverlayRendering();
	}
	...
	public static int getGuiScale() {
		int factor =  Minecraft.getMinecraft().mainWindow.getScaleFactor(Minecraft.getMinecraft().gameSettings.guiScale);
		if (factor == 0) {
			factor = 4;
		}
		return factor;
	...
	public static void setScaleFactor(int factor) {
		...
		Minecraft.getMinecraft().mainWindow.updateSize();
	}
	...
	public static IEntity getRenderViewEntity() {
		...
		return new IEntity(Minecraft.getMinecraft().getRenderViewEntity());
	}
